...
public class AttendingFragment extends Fragment {
    ...
    public static AttendingFragment newInstance(String runId) {
        AttendingFragment fragment = new AttendingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSwipeRefreshLayout =
                (SwipeRefreshLayout) rootView.findViewById(R.id.frg_attending_swipeRefreshLayout);
    ...
    private void initializeRecycler() {
        if (mAttendingList == null || mAttendingList.size() == 0) {
